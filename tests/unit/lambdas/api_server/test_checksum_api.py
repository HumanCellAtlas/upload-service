...
class TestChecksumApi(UploadTestCaseUsingMockAWS):
    ...
    def test_checksum_statuses_for_upload_area(self, mock_format_and_send_notification, mock_connect):
        ...
        checksum1_event = UploadedFileChecksumEvent(file_id=f1.db_id,
                                                    checksum_id=checksum1_id,
                                                    job_id='12345',
                                                    status="SCHEDULED")
        checksum2_event = UploadedFileChecksumEvent(file_id=f2.db_id,
                                                    checksum_id=checksum2_id,
                                                    job_id='23456',
                                                    status="CHECKSUMMING")
        checksum3_event = UploadedFileChecksumEvent(file_id=f3.db_id,
