...
export CHECKSUMMING_JOB_QUEUE_ARN=`( cd ${PROJECT_ROOT}/terraform/envs/${DEPLOYMENT_STAGE} ; terraform output csum_job_q_arn)`
export CHECKSUMMING_JOB_ROLE_ARN=`( cd ${PROJECT_ROOT}/terraform/envs/${DEPLOYMENT_STAGE} ; terraform output csum_job_role_arn)`
