...
export VALIDATION_JOB_QUEUE_ARN=`( cd ${PROJECT_ROOT}/terraform/envs/${stage} ; terraform output validation_job_q_arn)`
export VALIDATION_JOB_ROLE_ARN=`( cd ${PROJECT_ROOT}/terraform/envs/${stage} ; terraform output validation_job_role_arn)`
